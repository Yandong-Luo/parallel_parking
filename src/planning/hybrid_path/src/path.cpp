...
void Path::addSegment(const Node3D& node) {
  ...
  vertex.pose.position.x = node.getX() * m_mapInfo.cellSize + m_mapInfo.origin_x;
  vertex.pose.position.y = node.getY() * m_mapInfo.cellSize + m_mapInfo.origin_y;
...
void Path::addNode(const Node3D& node, int i) {
  ...
  pathNode.pose.position.x = node.getX() * m_mapInfo.cellSize + m_mapInfo.origin_x;
  pathNode.pose.position.y = node.getY() * m_mapInfo.cellSize + m_mapInfo.origin_y;
...
void Path::addVehicle(const Node3D& node, int i) {
  ...
  pathVehicle.pose.position.x = node.getX() * m_mapInfo.cellSize + m_mapInfo.origin_x;
  pathVehicle.pose.position.y = node.getY() * m_mapInfo.cellSize + m_mapInfo.origin_y;
