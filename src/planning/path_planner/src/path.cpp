...
void Path::addSegment(const Node3D& node) {
  ...
  vertex.pose.position.x = node.getX() * Constants::cellSize - Constants::offset_x;
  vertex.pose.position.y = node.getY() * Constants::cellSize - Constants::offset_y;
...
void Path::addNode(const Node3D& node, int i) {
  ...
  pathNode.pose.position.x = node.getX() * Constants::cellSize - Constants::offset_x;
  pathNode.pose.position.y = node.getY() * Constants::cellSize - Constants::offset_y;
...
void Path::addVehicle(const Node3D& node, int i) {
  ...
  pathVehicle.pose.position.x = node.getX() * Constants::cellSize - Constants::offset_x;
  pathVehicle.pose.position.y = node.getY() * Constants::cellSize - Constants::offset_y;
